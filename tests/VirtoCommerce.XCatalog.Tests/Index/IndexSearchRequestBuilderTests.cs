...
namespace VirtoCommerce.XCatalog.Tests.Index
{
    public class IndexSearchRequestBuilderTests : BaseMoqHelper
    {
        ...
        public void ParseFilters_Filters_MapsCorrectly(string filterName)
        {
            ...
            AssertFiltersContainFilterByTypeName(filters, filterName);
        }

...
/// <summary>
/// Verbatim reconstruction of the three non-facet <c>ConvertUsing</c> maps from the deleted
/// <c>ProductMappingProfile</c>, used as the real-behaviour oracle for their replacements.
/// </summary>
public class LegacyProductMappingProfile : Profile
{
    public LegacyProductMappingProfile()
    {
